...
public class RefreshController {
    ...
    public ResponseEntity<TokenResponseStatus> refresh(@RequestHeader("Authorization") String accessToken, HttpServletResponse response) throws UnsupportedEncodingException {
